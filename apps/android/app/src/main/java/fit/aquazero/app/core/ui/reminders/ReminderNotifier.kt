...
class ReminderNotifier @Inject constructor(
     ...
     *
     * The entry activity lives in `:app`, above this module, so the shell
     * supplies the destination rather than this class naming it. See
     * [AppEntryPoint].
     */
    private fun openAppIntent(): PendingIntent = appEntryPoint.openAppIntent()
}
