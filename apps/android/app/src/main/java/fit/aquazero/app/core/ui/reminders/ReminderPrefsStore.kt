 ...
 *
 * Below the features because that consent bit is collected twice: once during
 * setup and again in Settings, and either answer has to reach the schedule for
 * the switch to mean anything. Owned by Settings, onboarding could only honour
 * its own consent by importing Settings.
 */
@Singleton
