...
subtitle: Publishing AquaZeroFit to Replit and connecting the Hostinger domain
details:
  Document ID: AQF-22
...
# AquaZeroFit: Replit Deployment and Hostinger Domain Guide
...
| Test suite | **Ready.** 431 tests, 35 files |
...
| Reserved VM | ~$6 to 50/month depending on tier; the smallest tier suits this app initially |
...
5. **Full async store migration** to make Autoscale safe. **~5 to 7 days.**
